...
contract Deploy2 is Script {
    function run() public {
        ...
        address proxy = 0x95511296fcb546d379e31C9FD8BA30ebcFCC2Ff6;
        CLToken2 newToken = new CLToken2();
        CLToken(proxy).upgradeToAndCall(address(newToken), abi.encodeCall(CLToken2.initialize2, ()));
...
// == Logs ==
//   deployer :  0x38c30A38cbD6fD5333eb70eDA32078e51e7E3009
//   proxy :  0x95511296fcb546d379e31C9FD8BA30ebcFCC2Ff6

// forge script script/Upgrade.s.sol --rpc-url $env:RPC_SEPOLIA --private-key $env:PRIVATE_KEY --broadcast --verify
...
// cast call 0x95511296fcb546d379e31C9FD8BA30ebcFCC2Ff6 "owner()(address)"  --rpc-url $env:RPC_SEPOLIA
